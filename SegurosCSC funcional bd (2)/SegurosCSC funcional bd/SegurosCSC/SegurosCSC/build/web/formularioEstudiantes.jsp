...
<body>
    ...
    <main>
        <form action="ProcesarFormularioViaje" method="post">
            ...
            <label for="nomCentroE">Nombre del Centro Educativo:</label>
            <input type="text" name="nomCentroE" required>
